...
class ECAPA_TDNN(nn.Module):
    def __init__(self, channels=512, embd_dim=192, n_mels=40, log_input=True, **kwargs):
        super().__init__()
...
def MainModel(nOut=256, **kwargs):
    model = ECAPA_TDNN(in_channels=64, channels=512, embd_dim=nOut, **kwargs)
    return model
...
if __name__ == '__main__':
    ...
    x = torch.zeros(2, 200, 64)
    # model = ECAPA_TDNN(in_channels=64, channels=512, embd_dim=192)
